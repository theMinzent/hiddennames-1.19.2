...
public class HiddenNames {
    ...
    public static final DeferredRegister<ArgumentTypeInfo<?, ?>> ARG_TYPE_INFO_REG = DeferredRegister.create(Registry.COMMAND_ARGUMENT_TYPE_REGISTRY, MODID);//Registries.COMMAND_ARGUMENT_TYPE
